...
function renderSidebar(activePage) {
  const pages = [
    { id: 'dashboard', icon: '📊', label: 'ダッシュボード', href: '../dashboard/index.html' },
    { id: 'customer', icon: '🏢', label: '得意先一覧', href: '../customer/index.html' },
    { id: 'sales-input', icon: '✏️', label: '売上入力', href: '../sales-input/index.html' },
    { id: 'sales-list', icon: '📋', label: '売上一覧', href: '../sales-list/index.html' },
    { id: 'aggregation', icon: '📈', label: 'データ集計', href: '../aggregation/index.html' },
    { id: 'campaign', icon: '📣', label: 'キャンペーン管理', href: '../campaign/index.html' },
  ];
